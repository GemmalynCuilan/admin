	...
	<div class="modal-dialog">
		<div class="modal-content">
			<form method="POST" action="updatecode.php">
                ...
                <div class="form-group">
                           <label>Blood Type/Group</label>
                            <input type="text" readonly name="bloodGroup" value="<?php echo $row['bgroup']?>" class="form-control" required="required"/>
                </div>
                <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="patientname" class="form-control" placeholder="Enter name of patient"required>
            </div>
            <div class="form-group">
                <label> Date extracted </label>
                <input type="date" name="exdate" class="form-control" placeholder="Enter date extracted"required>
            </div>
            <div class="form-group">
            ...
            <textarea class="form-control" id="commentrel" name="commentrel"required></textarea>
          </div>
        </div>
        ...
        <button class="btn btn-secondary" type="button" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Close</button>
         <button name="updatebtn" class="btn btn-primary"><span class="glyphicon glyphicon-save"></span> Save</button>
        </div>
      </form>
		</div>
	</div>
