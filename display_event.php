<?php                
require 'config.php'; 
$display_query = "select event_id,event_name,event_description,event_venue,event_start_date,event_end_date,event_time from event";             
...
if($count>0) 
{
	...
	$data_arr[$i]['venue'] = $data_row['event_venue'];
	...
	$data_arr[$i]['time'] = date("h:i a", strtotime($data_row['event_time']));
