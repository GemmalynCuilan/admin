...
<head>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-danger">List of Pending Requests</h6>
            
        </div>
       <?php
                $query = "SELECT * FROM requests where status like 'pending'";
                        ...
                        ?>
                            <tr>
                                ...
                                <td class=" text-center">
                                    ...
                                    <button type = "submit" name="msg_btn" class ="btn btn-sm btn-outline-success">SEND</button>
                                    </form>
